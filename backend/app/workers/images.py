...
def extract_visual_keywords(scene: dict) -> str:
    ...
    Priority: image_prompt (English, SD-optimized) > visual + narration fallback.
    image_prompt is generated by the script worker specifically for AI image generation.
    """
    # image_prompt가 있으면 최우선 사용 (영어, SD 최적화)
    ...
    # Strip scene label prefix like "[장면 1]: " or "Scene 1: " or "[シーン 1]: "
    if "]: " in visual:
